...
const Login = (props: Props) => {
  ...
  return (
    <div className="bg-back object-cover relative font-montserrat h-screen">
        <div className="login-container absolute  top-8 right-1/2  translate-x-1/2 p-5 rounded-xl border-2 border-black-500 flex-col bg-primary items-center">
        <h1 className="text-3xl text-senary font-bold text-center my-4">Welcome Back</h1>
        <h2 className="text-center text-senary font-bold my-4 mx-5">Enter your e-mail and password to login</h2>
            <form onSubmit={handleSubmit} method="post" className="m-4 flex-col">
